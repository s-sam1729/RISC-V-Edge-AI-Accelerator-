...
module top_fpga #(
    ...
    ////////////////////////////////////////////////////////////
    pipe pipe_u (
        .clk(slow_clk), .reset(~reset), .stall(1'b0), .exception(exception), .pc_out(current_pc),
    ...
    coprocessor_top cop_u (
        ...
        .cop_we(1'b0), // DISCONNECT CPU: Prevents old firmware from overwriting MLP registers
        .cop_re(cop_re),
    ...
    assign log_cop_addr = 24'h000300 + {18'd0, log_class_idx, 2'b00};
    assign log_cop_re   = (log_state == 1);
